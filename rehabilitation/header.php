                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <ul class="scrollable-menu">
                                    ...
                                    <li><a href="hydro.php">Hydrocollator Packs</a></li>
                                    <li><a href="muscular.php">Muscular Taping</a></li>
                                    <li><a href="tecar.php">Tecar Theraphy</a></li>
                                    <li><a href="tens.php">Tens and EMS</a></li>
                                    <li><a href="thera.php">Therapeutic Exercises</a></li>
                                </ul> 
                        </li>
                    ...
                    <li class="dropdown"><a href="#"><span>Specialization</span> <i class="bi bi-chevron-down"></i></a>
                        <ul class="scrollable-menu">
                            ...
                            <li><a href="../specialization/family.php">Family Medicine</a></li>
