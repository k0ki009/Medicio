                    ...
                    <li class="dropdown"><a href="#"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <ul><li class="dropdown"><a href="../outpatient.php"><span>Radiology (Imaging)</span> <i class="bi bi-chevron-right"></i></a>
                                <ul class="scrollable-menu">
                                    <li><a href="64ct.php">64 Slice CT Scan</a></li>
                                    <li><a href="2d.php">2d Echo</a></li>
                                    <li><a href="ecg.php">ECG</a></li>
                                    <li><a href="mobile.php">Mobile X-Ray</a></li>
                                    <li><a href="ultra.php">Ultrasound</a></li>
                                    <li><a href="xray.php">X-Ray</a></li></li></li>
                                </ul>
