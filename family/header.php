                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <ul class="scrollable-menu">
                                <li><a href="emergencyserv.php">Emergency Services</a></li>
                                <li><a href="diet.php">Dietary Services</a></li>
                                <li><a href="neonatal.php">Neonatal Intensive Care Unit</a></li>
                                <li><a href="pharmacy.php">Pharmacy Services</a></li>
                                <li><a href="renal.php">Renal Dialysis Unit</a></li>
                            </ul> 
                        </li>
                        </ul>
                    </li>
